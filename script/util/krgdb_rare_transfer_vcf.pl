...
=head1 Usage
    ...
    perl krgdb_rare_transfer_vcf.pl [option] file
...
print $fh_out "##INFO=<ID=KRG_Rare_AF,Number=A,Type=Float,Description=\"Allele Frequency, for each ALT allele, in the same order as listed\">\n";
